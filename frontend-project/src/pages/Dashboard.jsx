  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-slate-500 mt-1">Here's an overview of your inventory system</p>
      </div>
        ...
        {cards.map((card, i) => {
          ...
          return (
            ...
            >
              ...
              <div className={`relative bg-white bg-gradient-to-br ${card.lightBg} rounded-2xl p-6 border border-slate-200/60 hover:border-transparent transition-all duration-500 shadow-sm hover:shadow-xl group-hover:-translate-y-1`}>
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm text-slate-500 group-hover:text-white/80 transition-colors duration-500">{card.label}</p>
                    <p className="text-4xl font-bold text-slate-900 group-hover:text-white transition-colors duration-500 mt-2 animate-count-up">
                      {value}
                    </p>
                  </div>
                  <div className={`w-14 h-14 ${card.iconBg} group-hover:bg-white/20 rounded-xl flex items-center justify-center text-3xl transition-all duration-500 group-hover:scale-110 group-hover:rotate-3`}>
                    {card.icon}
                  </div>
                </div>
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-slate-200/60 shadow-sm animate-slide-in" style={{ animationDelay: '0.3s' }}>
